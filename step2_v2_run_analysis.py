...
# BCL11B is the official HGNC symbol; CTIP2 is an alias for the same gene. Both datasets find BCL11B. Gene panel now uses the
...
# ANALYSIS 2: ERT framing
# Claim: ERT speed has the LARGEST early→late inflight SPEED change
# (not largest overall, AM accuracy is larger but that is accuracy, not speed, and VEN predicts speed not accuracy)
print("\n[2] ERT DOMAIN SPECIFICITY SPEED METRIC ONLY ")
...
# Tests whether ISS myelination is specifically elevated vs genome-wide background not just vs 0
...
# ANALYSIS 5: OSD-202 with permutation test 
...
# Fix 5
print(f"\n N=1 STATEMENT (Fix 5):")
print(f" 'The 340-day data represents a single case study (N=1 spaceflight astronaut, N=1 twin ground control); findings are hypothesis-")
